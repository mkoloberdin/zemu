...
public:
	...
	virtual void GenerateManyUsingSndRenderer (C_SndRenderer *sr, unsigned devClk) = 0;
...
void SAAAPI SAASNDGenerateManyUsingSndRenderer(SAASND object, C_SndRenderer *sr, unsigned devClk);
